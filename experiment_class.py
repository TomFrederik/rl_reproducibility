...
class Experiment:
    ...
    def __init__(self, seed, env_str, ac, ac_kwargs, ac_alg, ac_alg_kwargs, v=None, v_kwargs=None, v_alg=None, v_alg_kwargs=None, num_iters=100, ep_per_iter=5):
        '''
        Input:
        ...
        self.ac_alg = ac_alg(**ac_alg_kwargs)
